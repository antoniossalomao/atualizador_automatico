...
public class ScriptRunnerService
{
    ...
    /// </summary>
    public async Task<int> RunPendingScriptsAsync(string dbPath, string pacotesPath, string cnpjCliente, CancellationToken cancellationToken = default)
    {
        ...
        foreach (var scriptPath in scripts)
        {
            ...
            catch (Exception ex)
            {
                ...
                await _apiService.SendLog(cnpjCliente, "ERRO", relatorio);
                falhas++;
                continue;
            }
